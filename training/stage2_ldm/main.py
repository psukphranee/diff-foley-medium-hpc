...
class SetupCallback(Callback):
    ...
    # Panya: 12.2.24 change this because of deprecation after 1.5.3
...
if __name__ == "__main__":
    ...
    print("Callbacks: ", trainer_kwargs['callbacks'])
    ...
    if not cpu:
        ...
        print("Panya lightning_config.trainer.gpus: ", type(lightning_config.trainer.gpus))
