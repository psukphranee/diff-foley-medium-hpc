...
def cut_video_and_spec_vggsound_audioset_temporal_contrast(video, spec, sample_num=4, shift_lb=8):
    ...
    msg = f"Panya: [cut_video_and_spec_vggsound_audioset_temporal_contrast]: Attempting to concatenate sample_video_list of len {len(sample_video_list.shape)} along dimension 0"
    logging.info(msg)
